...
export default function EditMaterial() {
    const { states, erros, actions } = useEditMaterial()

    return (
        <Container>
            <FormComponent nomeForm={states.material ? 'Código : ' + states.material.serverId : ''}>
                ...
                {!states.isLoading ? (
                    <ButtonAction acao={'Salvar Edição'} onPressFunction={actions.handleClickEditButton} />
                ) : (
