...
export default function EquipmentMenuOptions() {
    const { states, animation, actions } = useEquipmentMenuOptions()
            ...
            <Container>
                <View style={{ width: '100%' }}>
                    <ButtonStyled
                        ...
                        onPress={() => actions.handleClickTypeList(MenuEquipmentType.EQUIPMENTS)}
                    >
                        <ImageStyled>
                            <Image
                    ...
                    <ButtonStyled
                        style={{ backgroundColor: '#000080' }}
                        onPress={() => actions.handleClickTypeList(MenuEquipmentType.WORKS)}
                    >
                        <ImageStyled>
                            <LottieView
                                autoPlay
                    ...
                    <ButtonStyled
                        style={{ backgroundColor: '#000080' }}
                        onPress={() => actions.handleClickTypeList(MenuEquipmentType.MAINTENANCE_TRUCKS)}
                    >
                        <ImageStyled>
                            <Image
    ...
    if (states.type && states.works.length == 0) {
        return (
            <Container>
                <Content>
                    <ListaVazia />
                    ...
                    renderItem={({ item }) => {
                        return (
                            <ItemObra
                                active={0.2}
                                onPress={() => {
                                    actions.handleClickItemWorkList(item)
                                }}
                                titulo={item.name}
