...
import { EquipmentUseCase } from '../use-cases/EquipmentUseCase'

export class EquipmentInteractor implements EquipmentUseCase {
    ...
    async updateHourMeterOrOdometerInLocalDatabase(
        ...
        return new EquipmentDto().entityToDto(
            await this.equipmentRepositoryGateway.updateHourMeterOrOdometerInLocalDatabase(entity)
        )
    }
