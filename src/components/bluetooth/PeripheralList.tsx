import { StrippedPeripheral } from '@/src/types'
...
const PeripheralList: React.FC<PeripheralListProps> = ({ peripherals, onConnect }) => {
    return (
            ...
            <FlatList
                ...
                renderItem={({ item }) => (
                    <TouchableOpacity onPress={() => onConnect(item)} style={styles.card}>
                        ...
                        <Text style={styles.subtitle}>Local Name: {item.localName ?? 'N/A'}</Text>
